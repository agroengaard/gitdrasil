...
#==============================================================================
plot \
    'plot2.dat' index 0 title 'NACA bitest' with lines linestyle 1 linewidth 2, \
    'plot2.dat' index 1 title 'Camber Line' with lines linestyle 2 linewidth 2
